        ...
        <tbody>
          ...
          for ($i=0; $i < count($dianJiResult); $i++) {
            ...
            <tr>
              ...
              <td>
                <a href="javascript:deleteDianJi('<?php echo $dianJiResult[$i]['item_no'];?>')">删除</a>
                <a href="/index.php/Admin/AdminDianJi/adminModifyDianJi?no='<?php echo $dianJiResult[$i]['item_no'];?>'">修改</a>
              </td>
            </tr>
            <?php
          }
...
<script type="text/javascript">
    ...
    function modifyDianJi(item_no){
      window.location.href="/index.php/Admin/AdminDianJi/adminModifyDianJi?no=" + item_no;
    }
